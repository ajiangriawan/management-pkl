@extends('layouts.app')
@section('title', 'Edit Admin Humas')

@section('content')
<div class="container mx-auto px-4 mt-8">
    <div class="max-w-2xl mx-auto bg-white shadow-lg rounded-xl p-6">
        <h3 class="text-center text-2xl font-bold text-blue-600 mb-6">Edit Admin Humas</h3>

        <form action="{{ route('admin.humass.update', $humas) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" id="nip" name="nip" required value="{{ old('nip', $humas->nip) }}"
                ...
                <div>
                    ...
                    <input type="text" id="nama" name="nama" required value="{{ old('nama', $humas->nama) }}"
                ...
                <div>
                    ...
                    <input type="email" id="email" name="email" required value="{{ old('email', $humas->email) }}"
                ...
                <div>
                    ...
                    <input type="number" id="telepon" name="telepon" required value="{{ old('telepon', $humas->telepon) }}"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="alamat" name="alamat" rows="3" required
                        class="w-full border border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-blue-400 @error('alamat') border-red-500 @enderror">{{ old('alamat', $humas->alamat) }}</textarea>
                    @error('alamat')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
