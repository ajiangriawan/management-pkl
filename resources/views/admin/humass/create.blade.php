...
<div class="container mx-auto px-4 mt-8">
    <div class="max-w-2xl mx-auto bg-white shadow-lg rounded-xl p-6">
        <h3 class="text-center text-2xl font-bold text-blue-600 mb-6">Tambah Guru Pebimbing</h3>
        ...
        <form action="{{ route('admin.teachers.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" id="nip" name="nip" placeholder="Masukkan NIP" required
                        value="{{ old('nip') }}"
