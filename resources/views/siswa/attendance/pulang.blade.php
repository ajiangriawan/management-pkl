...
<div class="container mx-auto p-6">
    <h1 class="text-2xl font-bold mb-4">Absensi Pulang PKL</h1>

    <!-- Lokasi GPS -->
    <div class="hidden mb-4 p-4 border rounded-lg bg-gray-100">
        <p><strong class="hidden">Lokasi Saat Ini:</strong> <span class="hidden" id="current-location">Mengambil lokasi...</span></p>
    </div>
    ...
    <!-- Form Absensi -->
    <form id="attendance-form" action="{{ route('siswa.attendance.storepulang') }}" method="POST" enctype="multipart/form-data" class="mt-6">
        @csrf
        ...
        <label class=" hidden block text-gray-700 font-bold mt-4">Jenis Absensi:</label>
        <select name="jenis_absensi" class="hidden border rounded-lg w-full p-2" required disabled>
